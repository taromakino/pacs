...
class DCNN(nn.Module):
    ...
    def __init__(
        ...
        self.features.add_module("tconv4", nn.ConvTranspose2d(num_features, num_features, 2, stride=2))
        self.features.add_module("norm5", nn.BatchNorm2d(num_features))
        self.features.add_module("relu5", nn.ReLU(True))
        self.features.add_module("tconv5", nn.ConvTranspose2d(num_features, num_features // 2, 7, stride=2, padding=3,
            output_padding=1))
        num_features = num_features // 2
        self.features.add_module("norm6", nn.BatchNorm2d(num_features))
        self.features.add_module("relu6", nn.ReLU(True))
        self.features.add_module("tconv6", nn.ConvTranspose2d(num_features, 3, 3, stride=1, padding=1))
