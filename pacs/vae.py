...
class VAE(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx, dataloader_idx):
        ...
        if dataloader_idx == 0:
            ...
            self.log('val_kl_causal', kl_causal, on_step=False, on_epoch=True, add_dataloader_idx=False)
            self.log('val_kl_spurious', kl_spurious, on_step=False, on_epoch=True, add_dataloader_idx=False)
