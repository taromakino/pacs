...
def make_data(test_env, train_ratio, batch_size, eval_batch_size, n_workers, n_test_examples):
    ...
    data_train = DataLoader(PACSDataset(df_train), shuffle=True, pin_memory=True, batch_size=batch_size,
